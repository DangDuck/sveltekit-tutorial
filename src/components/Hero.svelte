...
<SectionWrapper>
    <Header />
    <div
        class="flex flex-col gap-10 flex-1 items-center justify-center pb-50 md:pb-14"
    >
        <h2
        ...
        >
            Less thinking & more doing. We're the trainer for your pocket full
            of <span class="italic"
